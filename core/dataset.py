...
def read_data_sets(train_dir,
    ...
    TRAIN_IMAGES = 'training-images-and-ubyte_13.gz'
    TRAIN_LABELS = 'training-labels-and-ubyte_13.gz'
    VALIDATION_IMAGES = 'validation-images-and-ubyte_13.gz'
    VALIDATION_LABELS = 'validation-labels-and_ubyte_13.gz'
    TEST_IMAGES = 'testing-images-and-ubyte_13.gz'
    TEST_LABELS = 'testing-labels-and-ubyte_13.gz'
